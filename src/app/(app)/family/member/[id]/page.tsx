...
// RLS handles visibility: viewer sees personal items only if they share a
// household with the owner; household-scoped items also visible through families.
export default async function MemberClosetPage({
  ...
  return (
    <div className="space-y-5">
      ...
      {list.length === 0 ? (
        <EmptyState icon="👔" title="Nothing visible" description="Either they haven't added items yet, or what they've added is private." />
      ) : (
